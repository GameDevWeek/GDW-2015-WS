...
public class SimpleAnimationRenderSystem extends EntitySystem implements EntityListener {

    private static final EntityComparator comparator = new EntityComparator();
    private final ArrayList<Entity> entities = new ArrayList();
    private boolean resort;

    public SimpleAnimationRenderSystem() {
        super(0);
    }

    public SimpleAnimationRenderSystem(int priority) {
        super(priority);
    }
