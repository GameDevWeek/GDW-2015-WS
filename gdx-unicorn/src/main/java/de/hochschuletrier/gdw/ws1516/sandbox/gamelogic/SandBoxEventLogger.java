...
public class SandBoxEventLogger implements  EnemyActionEvent.Listener, DeathEvent.Listener , GameOverEvent.Listener, TriggerEvent.Listener, GameRespawnEvent.Listener  {
